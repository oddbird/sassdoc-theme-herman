!(function(e, t) {
  ...
  function b(e, t, n, r, i) {
    for (
      ...
      if ((o = e[p]) || 0 === o)
        if ('object' === te.type(o)) te.merge(d, o.nodeType ? [o] : o);
          ...
          for (
            a = a || f.appendChild(t.createElement('div')), s = (qe.exec(o) || [
              '',
              ''
            ])[1]
    ...
    for (f.textContent = '', p = 0; (o = d[p++]); )
      if (r && te.inArray(o, r) > -1) i && i.push(o);
        ...
        (
          (l = te.contains(o.ownerDocument, o)),
  ...
  function S(e, t, r, i) {
    ...
    if (
      ...
      if (u)
        for (c = s[s.length - 1].ownerDocument, te.map(s, k), f = 0; f < u; f++)
  ...
  function L(e, t, n) {
    for (var r, i = t ? te.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
      n || 1 !== r.nodeType || te.cleanData(m(r)), r.parentNode &&
        (
          n && te.contains(r.ownerDocument, r) && y(m(r, 'script')),
  ...
  function H(e, t, n, r, i) {
    ...
    for (
      ...
      'margin' === n && (a += te.css(e, n + De[o], !0, i)), r
        ? (
            'content' === n && (a -= te.css(e, 'padding' + De[o], !0, i)),
            'margin' !== n &&
              (a -= te.css(e, 'border' + De[o] + 'Width', !0, i))
          )
        : (
            (a += te.css(e, 'padding' + De[o], !0, i)),
            'padding' !== n &&
              (a += te.css(e, 'border' + De[o] + 'Width', !0, i))
          );
    return a;
  ...
  var ae = (function(e) {
    function t(e, t, n, r) {
      ...
      if (
        !r &&
        ((t ? t.ownerDocument || t : B) !== j && L(t), (t = t || j), O)
      ) {
        if (11 !== h && (u = ge.exec(e)))
          if ((i = u[1])) {
            if (9 === h) {
      ...
      c = {
        ...
        remove: function() {
          return te.each(arguments, function(e, t) {
            for (var n; (n = te.inArray(t, o, n)) > -1; )
              o.splice(n, 1), n <= u && u--;
          }), this;
        },
        has: function(e) {
                ...
                t
                  ...
                  : (
                      te.Deferred.getStackHook &&
                        (d.stackTrace = te.Deferred.getStackHook()),
                      e.setTimeout(d)
                    );
              };
            }
    ...
    when: function(e) {
      ...
      if (
        ...
        (
          ...
          'pending' === o.state() || te.isFunction(i[n] && i[n].then)
        )
      )
        return o.then();
  ...
  (te.fn.ready = function(e) {
    ...
    ready: function(e) {
      (!0 === e ? --te.readyWait : te.isReady) ||
        (
          (te.isReady = !0),
          (!0 !== e && --te.readyWait > 0) || ye.resolveWith($, [te])
        );
    }
      ...
      if (v && (u = v.events)) {
        for (l = (t = (t || '').match(ve) || ['']).length; l--; )
          if (
            ...
            for (
              f = te.event.special[p] || {}, d =
                u[(p = (r ? f.delegateType : f.bindType) || p)] || [], s =
                s[2] &&
                new RegExp(
                  '(^|\\.)' + h.join('\\.(?:.*\\.|)') + '(\\.|$)'
                ), a = o = d.length;
          ...
          for (
            ...
            (s.rnamespace && !s.rnamespace.test(o.namespace)) ||
              (
                ...
                (s.data = o.data),
                void 0 !==
                  (r = ((te.event.special[o.origType] || {}).handle ||
                    o.handler)
                    .apply(i.elem, u)) &&
                  !1 === (s.result = r) &&
  ...
  te.extend({
    ...
    style: function(e, t, n, r) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        ...
        if (
          (
            (t = te.cssProps[s] || (te.cssProps[s] = O(s) || s)),
          ...
          : (
              (1 === o && te.isXMLDoc(e)) ||
                (i =
                  ...
                  (te.expr.match.bool.test(t) ? Ze : void 0)),
              void 0 !== n
                ? null === n
      ...
      return 'boolean' == typeof t && 'string' === n
        ...
        : te.isFunction(e)
          ...
          : this.each(function() {
              var t, r, i, o;
              if ('string' === n)
                for (r = 0, i = te(this), o = e.match(ve) || []; (t = o[r++]); )
                  i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
              else
                (void 0 !== e && 'boolean' !== n) ||
                  (
                    (t = R(this)) && we.set(this, '__className__', t),
                    this.setAttribute &&
                      this.setAttribute(
                        'class',
        ...
        i = this[0];
      {
        ...
        if (i)
          return (t =
            ...
            : (
                (n = i.value),
                'string' == typeof n ? n.replace(rt, '') : null == n ? '' : n
              );
      }
    }
  }), te.extend({
        ...
        (
          ...
          3 !== r.nodeType &&
            ...
            (
              ...
              (t = t[te.expando]
                ? t
                : new te.Event(p, 'object' == typeof t && t)),
              (t.isTrigger = i ? 2 : 3),
              (t.namespace = h.join('.')),
  ...
  (te.param = function(e, t) {
    ...
    wrapAll: function(e) {
      ...
      return this[0] &&
        (
          te.isFunction(e) && (e = e.call(this[0])),
      ...
      if (this[0]) {
        ...
        return 'fixed' === te.css(n, 'position')
          ...
          : (
              (e = this.offsetParent()),
              (t = this.offset()),
              te.nodeName(e[0], 'html') || (r = e.offset()),
              (r = {
