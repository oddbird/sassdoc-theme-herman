...
module.exports = {
  ...
  // cacheDirectory: "/private/var/folders/lc/8svywbfn33l06bgj29w0_px80000gn/T/jest_dx",
  ...
  coveragePathIgnorePatterns: ['/node_modules/', 'assets/js/init.js'],
  ...
  setupFilesAfterEnv: ['<rootDir>test/clientjs/setupTests.js'],
  ...
  testMatch: ['<rootDir>test/clientjs/**/?(*.)+(spec|test).js?(x)'],
