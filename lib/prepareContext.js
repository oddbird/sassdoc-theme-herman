...
const normalizeGroups = require('./utils/normalizeGroups');
...
module.exports = ctx => {
  ...
  ctx.originalGroups = extend({}, ctx.groups);
  // Normalize groups setting (remove nesting)
  ctx.groups = normalizeGroups(ctx.groups, ctx.logger);
