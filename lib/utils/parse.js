      ...
      if (isValid) {
        ...
        if (data[variant]) {
          ...
          if (typeof data[variant] !== 'string') {
            // Override top-level `local` with variant-specific setting
            if (data[variant].local) {
              local = data[variant].local;
            }
            // Override top-level `svgid` with variant-specific setting
