  ...
  compiler.plugin('after-emit', (compilation, cb) => {
    ...
    sassdoc('./scss/**/*.scss', {
      ...
      groups: {
        ...
        'style-code': '_Code Highlighting',
        'style-regions': '_Layout Regions',
        'style-banner': '_Region: Banner',
        'style-nav': '_Region: Nav',
        'style-main': '_Region: Main',
        'component-nav': '_Components: Nav',
        'component-footer': '_Components: Footer',
        'component-breadcrumb': '_Components: Breadcrumb',
      },
    }).then(
      () => {
